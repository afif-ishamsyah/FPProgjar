...
#	data_ip.append('127.0.0.1')
#	data_port.append(3572)
#	data_port.append(3573)
...
#			responses=serv_0.recv(2048)
			responses=respo+'127.0.0.1:3273\n'
		elif pointer==1:
#			serv_1.send(datas)
#			responses=serv_1.recv(2048)
			responses=respo+'127.0.0.1:3272\n'
		print data		
		print responses
